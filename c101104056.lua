...
function c101104056.initial_effect(c)
	...
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(101104056,1))
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCountLimit(1,101104056+EFFECT_COUNT_CODE_OATH)
	e1:SetCondition(c101104056.setcon)
	e1:SetCost(c101104056.setcost)
	e1:SetTarget(c101104056.settg)
	e1:SetOperation(c101104056.setop)
	c:RegisterEffect(e1)
end
