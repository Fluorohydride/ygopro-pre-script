...
function c55312487.initial_effect(c)
	...
	e2:SetValue(c55312487.atlimit)
	c:RegisterEffect(e2)
end
function c55312487.spfilter1(c,e,tp)
	return (c:IsSetCard(0xfe) or c:IsSetCard(0x117)) and Duel.GetMZoneCount(tp,c)>0
...
function c55312487.spfilter2(c,e,tp,code)
	return (c:IsSetCard(0xfe) or c:IsSetCard(0x117)) and c:GetOriginalCode()~=code and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
