...
function c73341839.cfilter(c,tp)
	return c:IsLinkBelow(3) and Duel.GetMZoneCount(tp,c)>0
end
function c73341839.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c73341839.cfilter,1,nil,tp) end
	local sg=Duel.SelectReleaseGroup(tp,c73341839.cfilter,1,1,nil,tp)
