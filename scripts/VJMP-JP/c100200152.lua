...
function c100200152.initial_effect(c)
	...
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(100200152,1))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_DELAY)
	e1:SetCode(EVENT_SUMMON_SUCCESS)
	e2:SetCountLimit(1,100200152+100)
	e1:SetTarget(c100200152.sptg2)
	e1:SetOperation(c100200152.spop2)
	c:RegisterEffect(e1)
end
...
function c100200152.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
