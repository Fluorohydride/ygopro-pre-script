...
function c96462121.tgfilter(c,e,tp)
	if not (c:IsFaceup() and c:IsType(TYPE_XYZ) and c:IsSetCard(0x127) and Duel.GetLocationCountFromEx(tp,tp,c)>0) then return false end
...
function c96462121.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(tp) and c96462121.tgfilter(chkc,e,tp) end
