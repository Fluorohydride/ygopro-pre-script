...
function s.cfilter(c,tp)
	return c:IsPreviousLocation(LOCATION_MZONE) and c:GetOriginalAttribute()==ATTRIBUTE_FIRE and (c:IsReason(REASON_BATTLE) or c:IsReason(REASON_EFFECT)) and c:IsPreviousControler(tp)
end
