...
function s.cfilter(c,tp,se)
	return c:IsPreviousControler(tp) and (c:GetPreviousTypeOnField()&TYPE_MONSTER>0 or not c:IsPreviousLocation(LOCATION_ONFIELD)) and c:GetOriginalAttribute()==ATTRIBUTE_FIRE
