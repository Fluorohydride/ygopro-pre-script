...
function c700908043.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c700908043.target)
	e1:SetOperation(c700908043.operation)
	c:RegisterEffect(e1)
end
function c700908043.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c700908043.operation(e,tp,eg,ep,ev,re,r,rp)
	local g1=Duel.GetFieldGroup(tp,0,LOCATION_HAND)
	local g2=Duel.GetFieldGroup(tp,LOCATION_HAND,0)
