...
function c101110072.setcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 
		return true
	end
end
--function c101110072.setcon(e,tp,eg,ep,ev,re,r,rp)
	--return Duel.IsExistingMatchingCard(c11100005.setfilter,tp,LOCATION_MZONE+LOCATION_SZONE,0,1,nil)
--end
function c101110072.settg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then 
		return e:GetHandler():IsSSetable() and Duel.IsExistingMatchingCard(c11100005.setfilter,tp,LOCATION_MZONE+LOCATION_SZONE,0,1,nil)
	end
