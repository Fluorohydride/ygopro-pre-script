...
function c101107023.initial_effect(c)
	...
	e1:SetCost(c101107023.spcost)
	e1:SetCondition(c101107023.thcon)
	e1:SetTarget(c101107023.thtg)
	e1:SetOperation(c101107023.thop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c101107023.thcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp and (Duel.GetCurrentPhase()==PHASE_MAIN1 or Duel.GetCurrentPhase()==PHASE_MAIN2) and eg:IsExists(c101107023.cfilter,1,nil,tp)
end
