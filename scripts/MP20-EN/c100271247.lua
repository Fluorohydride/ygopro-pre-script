...
function c100271247.rmcon(e,tp,eg,ep,ev,re,r,rp)
    return eg:GetFirst():IsType(e:GetLabel()) and eg:GetFirst():GetFlagEffect(100271247)~=0
end
...
function c100271247.valcheck(e,c)
    ...
    elseif c:IsType(TYPE_FUSION) and g:IsExists(Card.IsFusionCode,1,nil,25451652) g:IsExists(c100271247.mtfilter2,1,nil) then
        c:RegisterFlagEffect(100271247,RESET_EVENT+0x4fe0000+RESET_PHASE+PHASE_END,0,1)
    end
end
