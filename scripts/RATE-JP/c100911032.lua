...
--Script by nekrozar
function c100911032.initial_effect(c)
	c:EnableReviveLimit()
	...
	e2:SetCondition(c100911032.spcon)
	e2:SetOperation(c100911032.spop)
	c:RegisterEffect(e2)
	--atk/def
...
function c100911032.spop(e,tp,eg,ep,ev,re,r,rp,c)
	local ft=Duel.GetLocationCount(tp,LOCATION_MZONE)
	local ct=-ft+1
