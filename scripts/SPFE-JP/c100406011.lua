...
function c100406011.spfilter(c,e,tp)
	return (c:IsFusionSetCard(0x1f3) or c:IsFusionCode(96622984,22011689,69105797)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c100406011.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c100406011.filter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,1,nil,e,tp)
	local tc=g:GetFirst()
