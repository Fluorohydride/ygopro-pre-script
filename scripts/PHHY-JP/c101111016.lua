...
function c101111016.initial_effect(c)
	...
	e2:SetCondition(c101111016.condition)
	e2:SetCountLimit(1,101111016)
...
function c101111016.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_PZONE)
end
function c101111016.thfilter(c)
	return c:GetType()==TYPE_SPELL and c:IsSSetable() and c:IsSetCard(0x20ec)
end
