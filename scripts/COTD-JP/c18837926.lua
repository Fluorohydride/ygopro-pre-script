...
function c18837926.initial_effect(c)
	...
	e1:SetTarget(c18837926.sumtg)
	e1:SetOperation(c18837926.sumop)
	c:RegisterEffect(e1)
end
function c18837926.filter(c,e,tp)
	return c:IsLevelBelow(4) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c18837926.sumtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c18837926.sumop(e,tp,eg,ep,ev,re,r,rp)
