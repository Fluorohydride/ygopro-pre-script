...
function c101202071.initial_effect(c)
	...
	e1:SetCondition(c101202071.xyzcond)
...
function c101202071.xyzcond(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101202071.tgfilter(c,tp)
...
function c101202071.eqfilter(c,tp)
...
function c101202071.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c101202071.tgfilter(chkc,tp) end
	if chk==0 then
		local ft=Duel.GetLocationCount(tp,LOCATION_SZONE)
		return ft>0 and Duel.IsExistingTarget(c101202071.tgfilter,tp,LOCATION_MZONE,0,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
	Duel.SelectTarget(tp,c101202071.tgfilter,tp,LOCATION_MZONE,0,1,1,nil,tp)
...
function c101202071.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	local ec=Duel.SelectMatchingCard(tp,c101202071.eqfilter,tp,LOCATION_MZONE+LOCATION_GRAVE,0,1,1,tc,tp):GetFirst()
