...
function c100417025.initial_effect(c)
	...
	e1:SetCondition(c100417025.con)
	e1:SetCost(c100417025.cost)
	e1:SetTarget(c100417025.tar)
	e1:SetOperation(c100417025.op)
	c:RegisterEffect(e1)
	Duel.AddCustomActivityCounter(100417025,ACTIVITY_CHAIN,c100417025.chainfilter)
end
function c100417025.con(e,tp,eg,ep,ev,re,r,rp)
...
function c100417025.tar(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100417025.op(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(Card.IsCode,tp,LOCATION_DECK,0,nil,100417029)
	if not Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_SZONE,0,1,nil,100417029) and g:GetCount()>0 
