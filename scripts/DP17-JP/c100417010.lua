...
function c100417010.dirfilter(c)
	return c:GetFlagEffect(100417010)==0
end
function c100417010.dirtg(e,c)
	return not Duel.IsExistingMatchingCard(c100417010.dirfilter,c:GetControler(),0,LOCATION_MZONE,1,nil)
end
