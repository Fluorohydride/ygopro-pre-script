...
--Scripted by mallu11
function c101101010.initial_effect(c)
	c:EnableReviveLimit()
	...
	e1:SetDescription(aux.Stringid(101101010,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_REMOVE)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetRange(LOCATION_HAND)
	e1:SetTarget(c101101010.sptg)
	e1:SetOperation(c101101010.spop)
	c:RegisterEffect(e1)
	--destroy
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(101101010,1))
	e2:SetCategory(CATEGORY_DESTROY+CATEGORY_DAMAGE)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_F)
	e2:SetCode(EVENT_BATTLE_START)
	e2:SetCondition(c101101010.descon)
	e2:SetTarget(c101101010.destg)
	e2:SetOperation(c101101010.desop)
	c:RegisterEffect(e2)
end
function c101101010.cfilter(c)
...
function c101101010.spop(e,tp,eg,ep,ev,re,r,rp)
