...
function c100414023.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b2=e:IsHasType(EFFECT_TYPE_ACTIVATE) and Duel.IsExistingMatchingCard(c100414023.thfilter,tp,LOCATION_DECK,0,1,nil)
...
function c100414023.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and Duel.SendtoHand(tc,nil,REASON_EFFECT)~=0 then
		...
		if param==1 and e:IsHasType(EFFECT_TYPE_ACTIVATE) and tc:IsLocation(LOCATION_HAND)
