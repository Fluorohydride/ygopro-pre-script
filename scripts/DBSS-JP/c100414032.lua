...
function c100414032.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SpecialSummon(c,0,tp,tp,true,false,POS_FACEUP)~=0 and Duel.IsExistingMatchingCard(Card.IsCode,tp,LOCATION_ONFIELD,0,1,nil,100414027) and  Duel.IsExistingMatchingCard(c100414032.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(100414032,2)) then
		Duel.BreakEffect()
		local g=Duel.SelectMatchingCard(tp,c100414032.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
