...
function c101007091.valkyriefilter(c)
...
function c101007091.drtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local ct=Duel.GetMatchingGroupCount(c101007091.valkyriefilter,tp,LOCATION_MZONE,0,nil)
...
function c101007091.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c101007091.valkyriefilter,tp,LOCATION_MZONE,0,1,nil)
