...
function c101007083.matfilter(c,tp)
	return c:IsSetCard(0x200) and c:IsType(TYPE_XYZ) and c:IsFaceup()
...
function c101007083.mattg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return c101007083.matfilter(c,tp)
		and chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) end
