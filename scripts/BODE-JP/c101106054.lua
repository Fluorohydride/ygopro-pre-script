...
function c101106054.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(101106054,0))
...
function c101106054.lvop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		if tc:IsLevel(1) then
			sel=Duel.SelectOption(tp,aux.Stringid(101106054,1))
		else
			sel=Duel.SelectOption(tp,aux.Stringid(101106054,1),aux.Stringid(101106054,2))
		end
		if sel==1 then
			lvl=-1
		end
