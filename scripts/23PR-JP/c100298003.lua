...
function c100298003.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100298003,0))
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_MZONE)
	e2:SetCountLimit(1,100298003+100)
	e2:SetCost(c100298003.pencost)
...
function c100298003.pencost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100298003.penop1(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsExistingMatchingCard(aux.NecroValleyFilter(c100298003.pmfilter),tp,LOCATION_GRAVE,0,1,nil) and Duel.SelectYesNo(tp,aux.Stringid(100298003,1)) then
