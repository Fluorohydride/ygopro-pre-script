...
function c50954680.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(50954680,0))
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c50954680.condition)
	e2:SetTarget(c50954680.target)
	e2:SetOperation(c50954680.operation)
	c:RegisterEffect(e2)
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e2:SetCode(EVENT_DAMAGE_CALCULATING)
	e2:SetCondition(c50954680.condtion)
...
function c50954680.condtion(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
