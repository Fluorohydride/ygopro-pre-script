...
function c100236105.initial_effect(c)
	...
	e2:SetCountLimit(1,100236105+10)
...
function c100236105.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsDiscardable()
		and Duel.IsExistingMatchingCard(c100236105.cfilter,tp,LOCATION_HAND,0,1,e:GetHandler()) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DISCARD)
	local g=Duel.SelectMatchingCard(tp,c100236105.cfilter,tp,LOCATION_HAND,0,1,1,e:GetHandler())
