...
function c100415010.eqfilter(c,check)
	return (c:IsFaceup() or not c:IsLocation(LOCATION_MZONE)) and c:IsSetCard(0x251) and c:IsType(TYPE_MONSTER) and not c:IsLevel(4)
...
function c100415010.check(tp,type)
...
function c100415010.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	local check=c100415010.check(tp,TYPE_FUSION) and c100415010.check(tp,TYPE_SYNCHRO) and c100415010.check(tp,TYPE_XYZ) and c100415010.check(tp,TYPE_LINK)
