...
--Scripted by mallu11
function c100415035.initial_effect(c)
	--Activate
	...
	e1:SetCountLimit(1,100415035+EFFECT_COUNT_CODE_OATH)
	e1:SetCondition(c100415035.condition)
	e1:SetTarget(c100415035.target)
	e1:SetOperation(c100415035.activate)
	c:RegisterEffect(e1)
end
function c100415035.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()==PHASE_MAIN1 or Duel.GetCurrentPhase()==PHASE_MAIN2
end
function c100415035.filter(c)
	return c:IsFaceup() and (c:IsSetCard(0x250) or c:IsType(TYPE_RITUAL)) and c:IsAttackAbove(1000)
end
...
function c100415035.activate(e,tp,eg,ep,ev,re,r,rp)
