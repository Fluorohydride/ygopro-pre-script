...
function c100415028.initial_effect(c)
	...
	e1:SetValue(c100415028.splimit)
	c:RegisterEffect(e1)
	--spsummon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(100415028,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_SEARCH+CATEGORY_TOHAND)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_HAND+LOCATION_GRAVE)
	e2:SetCountLimit(1,100415028)
	e2:SetCost(c100415028.spcost)
	e2:SetTarget(c100415028.sptg)
	e2:SetOperation(c100415028.spop)
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(100415028,ACTIVITY_SPSUMMON,c100415028.counterfilter)
end
function c100415028.splimit(e,se,sp,st)
	return se:GetHandler():IsSetCard(0x250)
end
function c100415028.counterfilter(c)
...
function c100415028.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetTarget(c100415028.splimit2)
...
function c100415028.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100415028.thfilter(c)
