...
function c100420002.initial_effect(c)
	...
	e0:SetValue(c100420002.splimit)
	c:RegisterEffect(e0)
	...
	e2:SetCountLimit(1,100420002+100)
	e2:SetTarget(c100420002.tgtg)
	e2:SetOperation(c100420002.tgop)
	c:RegisterEffect(e2)
	...
	e3:SetCountLimit(1,100420002+200)
	e3:SetTarget(c100420002.tdtg)
	e3:SetOperation(c100420002.tdop)
	c:RegisterEffect(e3)
end
function c100420002.splimit(e,se,sp,st)
	return se:IsHasType(EFFECT_TYPE_ACTIONS)
end
function c100420002.dspcon(e,tp,eg,ep,ev,re,r,rp)
