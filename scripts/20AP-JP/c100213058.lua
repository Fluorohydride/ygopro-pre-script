...
function c100213058.initial_effect(c)
	...
	e3:SetCondition(c100213058.pubcon)
	e3:SetTarget(c100213058.pubtg)
	e3:SetLabelObject(g)
	c:RegisterEffect(e3)
	--cannot summon
	...
	e4:SetCondition(c100213058.scon1)
	e4:SetLabelObject(g)
	c:RegisterEffect(e4)
	local e5=e4:Clone()
	...
	e6:SetCondition(c100213058.scon2)
	c:RegisterEffect(e6)
	local e7=e6:Clone()
...
function c100213058.drop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:GetFlagEffect(100213058)==0 then
		c:RegisterFlagEffect(100213058,RESET_EVENT+0x1ff0000,0,1)
		pg:Clear()
	end
...
function c100213058.pubcon(e)
	return e:GetHandler():GetFlagEffect(100213058)~=0
end
function c100213058.pubtg(e,c)
	return e:GetLabelObject():IsContains(c) and c:GetFlagEffect(100213158)~=0
end
function c100213058.sfilter(c,pg)
...
function c100213058.scon1(e)
	...
	return Duel.IsExistingMatchingCard(c100213058.sfilter,tp,LOCATION_HAND,0,1,nil,e:GetLabelObject())
end
function c100213058.scon2(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsExistingMatchingCard(c100213058.sfilter,tp,0,LOCATION_HAND,1,nil,e:GetLabelObject())
end
