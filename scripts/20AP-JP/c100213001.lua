...
function c100213001.initial_effect(c)
	...
	e1:SetOperation(c100213001.atkop1)
	c:RegisterEffect(e1)
	--Decrease ATK
	...
	e2:SetCondition(c100213001.atkcon)
	e2:SetTarget(c100213001.atktg)
	e2:SetOperation(c100213001.atkop2)
	c:RegisterEffect(e2)
end
function c100213001.atkop1(e,tp,eg,ep,ev,re,r,rp)
...
function c100213001.atkcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100213001.atkop2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
