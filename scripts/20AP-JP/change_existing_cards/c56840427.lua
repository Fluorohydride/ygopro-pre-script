...
function c56840427.subfilter(c)
...
function c56840427.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b2=Duel.IsExistingMatchingCard(c56840427.subfilter,tp,LOCATION_GRAVE,0,1,nil)
	if chk==0 then return b1 or b2 end
	if not b1 or Duel.SelectYesNo(tp,aux.Stringid(100213056,2)) then
		local tg=Duel.GetFirstMatchingCard(c56840427.subfilter,tp,LOCATION_GRAVE,0,nil)
