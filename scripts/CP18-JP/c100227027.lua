...
function c100227027.valcon(e,re,r,rp)
...
function c100227027.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	c:RegisterFlagEffect(100227027,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,0,1)
end
...
function c100227027.ctfilter(c)
	return c:GetSequence()<5
end
function c100227027.tdcon(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(c100227027.ctfilter,tp,LOCATION_SZONE,0,1,e:GetHandler())
end
