...
function c100227021.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100227021,0))
	e2:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_SUMMON_PROC)
	e2:SetRange(LOCATION_HAND)
	e2:SetCondition(c100227021.spcon)
	c:RegisterEffect(e2)
	--indes
	...
	e6:SetCondition(c100227021.lpcon)
	e6:SetOperation(c100227021.lpop)
	c:RegisterEffect(e6)
	--to deck
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(100227021,1))
	...
	e7:SetTarget(c100227021.tdtg)
	e7:SetOperation(c100227021.tdop)
	c:RegisterEffect(e7)
end
...
function c100227021.lpop(e,tp,eg,ep,ev,re,r,rp)
	Duel.SetLP(1-tp,math.ceil(Duel.GetLP(1-tp)/2))
end
function c100227021.tdcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c100227021.tdtg(e,tp,eg,ep,ev,re,r,rp,chk)
