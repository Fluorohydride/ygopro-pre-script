...
function c100227009.descon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsAbleToEnterBP() and Duel.IsEnvironment(100227010)
end
function c100227009.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsOnField() end
	local c=e:GetHandler()
	if chk==0 then return c:GetEffectCount(EFFECT_EXTRA_ATTACK)==0
		and c:GetEffectCount(EFFECT_EXTRA_ATTACK_MONSTER)==0
