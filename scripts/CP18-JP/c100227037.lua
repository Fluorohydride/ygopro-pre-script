...
function c100227037.ntcon(e,c,minc)
	...
	return minc==0 and c:IsLevelAbove(5) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		or Duel.IsExistingMatchingCard(c100227037.cfilter,tp,LOCATION_MZONE,0,1,nil))
end
...
function c100227037.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rp==1-tp and g and g:IsExists(c100227037.filter2,1,nil,tp) and Duel.IsChainNegatable(ev)
end
