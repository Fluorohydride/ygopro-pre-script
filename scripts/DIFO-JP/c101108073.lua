...
function c101108073.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=g:Filter(c101108073.fcheck,nil,g):Select(tp,1,1,nil)
	if sg and Duel.SendtoHand(sg,nil,REASON_EFFECT) and sg:GetFirst():IsLocation(LOCATION_HAND) then
