...
function c101108059.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c101108059.filter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
...
function c101108059.repfilter(c,tp)
	return c:IsFaceup() and c:IsSetCard(0x27b) and c:IsType(TYPE_LINK) and c:IsLocation(LOCATION_MZONE)
