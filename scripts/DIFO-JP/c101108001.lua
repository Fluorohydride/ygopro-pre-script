...
function c101108001.pentg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101108001.penfilter,tp,LOCATION_DECK,0,1,nil) end
end
...
function c101108001.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectMatchingCard(tp,c101108001.costfilter,tp,LOCATION_HAND,0,1,1,nil)
...
function c101108001.thop(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsRelateToEffect(e) then
		...
		if g:GetCount()>0 and Duel.SelectYesNo(tp,aux.Stringid(101108001,0)) then
