...
function c101002072.target1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.IsExistingMatchingCard(c101002072.cfilter,tp,LOCATION_HAND+LOCATION_ONFIELD,0,1,c)
		and Duel.IsExistingMatchingCard(c101002072.thfilter,tp,LOCATION_DECK,0,1,nil)
		and Duel.SelectYesNo(tp,94) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
		local g=Duel.SelectMatchingCard(tp,c101002072.cfilter,tp,LOCATION_HAND+LOCATION_ONFIELD,0,1,1,c)
...
function c101002072.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
