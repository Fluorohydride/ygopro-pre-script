...
function c101004013.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c101004013.filter,tp,LOCATION_DECK,0,1,nil,e,tp) end
...
function c101004013.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.GetFirstMatchingCard(c101004013.filter,tp,LOCATION_DECK,0,nil,e,tp)
	if tc then
