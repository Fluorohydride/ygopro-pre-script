...
function c100423048.initial_effect(c)
	...
	e3:SetCondition(c100423048.fdcon)
	e3:SetOperation(c100423048.fdop)
	c:RegisterEffect(e3)
	...
	e4:SetOperation(c100423048.fdop)
	c:RegisterEffect(e4)
	e4:SetLabelObject(e1)
end
function c100423048.fdcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPosition(POS_FACEDOWN) and e:GetHandler():IsLocation(LOCATION_FZONE)
end
function c100423048.fdop(e,tp,eg,ep,ev,re,r,rp)
...
function c100423048.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=ng:Filter(c100423048.thfilter,nil,p)
