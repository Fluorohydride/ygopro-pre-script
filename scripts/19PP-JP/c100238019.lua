...
function c100238019.cfilter(c,tp)
...
function c100238019.spcon1(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c100238019.cfilter,1,nil,tp)
end
...
function c100238019.cfilter1(c,tp)
	return c:IsReason(REASON_EFFECT) and c:IsLocation(LOCATION_GRAVE) and (c:GetPreviousLocation(LOCATION_HAND) or c:GetPreviousLocation(LOCATION_ONFIELD)) and c:GetPreviousControler()==tp and c:GetReasonPlayer()==1-tp
end
function c100238019.spcon2(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c100238019.cfilter1,1,nil,tp)
end
