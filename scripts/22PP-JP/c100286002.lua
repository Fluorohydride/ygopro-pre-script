...
function c100286002.initial_effect(c)
	...
	e1:SetTarget(c100286002.tgtg)
	e1:SetOperation(c100286002.tgop)
	c:RegisterEffect(e1)
	--must attack
	...
	e3:SetValue(c100286002.atklimit)
	c:RegisterEffect(e3)
	--castling
...
function c100286002.tgtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAttackPos()
		and Duel.IsExistingMatchingCard(c100286002.tgfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_POSITION,e:GetHandler(),1,0,0)
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,nil,1,tp,LOCATION_DECK)
end
function c100286002.tgop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local g=Duel.GetMatchingGroup(c100286002.tgfilter,tp,LOCATION_DECK,0,nil)
...
function c100286002.atklimit(e,c)
	return c==e:GetHandler()
end
function c100286002.clfilter(c,e,tp)
...
function c100286002.cltg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	local c=e:GetHandler()
	if chkc then return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c100286002.clfilter(chkc,e,tp) end
