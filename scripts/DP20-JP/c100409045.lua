...
function c100409045.initial_effect(c)
	...
	e3:SetCondition(c33823832.spcon)
	e3:SetTarget(c33823832.sptg)
	e3:SetOperation(c33823832.spop)
	c:RegisterEffect(e3)
	--spsummon (deck)
	...
	e5:SetCondition(c71696014.spcon2)
	e5:SetTarget(c71696014.sptg2)
	e5:SetOperation(c71696014.spop2)
	c:RegisterEffect(e5)
end
