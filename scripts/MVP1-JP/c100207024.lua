...
function c100207024.initial_effect(c)
	...
	e2:SetCondition(c100207024.tgcon)
	e2:SetOperation(c100207024.tgop)
	...
	e5:SetCondition(c100207024.descon)
	e5:SetOperation(c100207024.desop)
	c:RegisterEffect(e5)
end
...
function c100207024.tgcon(e,tp,eg,ep,ev,re,r,rp)
	return re==e:GetLabelObject()
end
function c100207024.tgop(e,tp,eg,ep,ev,re,r,rp)
...
function c100207024.indtg(e,c)
	return e:GetHandler():IsHasCardTarget(c)
end
function c100207024.descon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetHandler():GetFirstCardTarget()
	return tc and eg:IsContains(tc)
end
function c100207024.desop(e,tp,eg,ep,ev,re,r,rp)
