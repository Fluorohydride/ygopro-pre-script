...
function c100207025.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(100207025,0))
	e3:SetCategory(CATEGORY_DAMAGE)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e3:SetCode(EVENT_DAMAGE_STEP_END)
	e3:SetRange(LOCATION_SZONE)
	e3:SetCountLimit(1)
	e3:SetCondition(c100207025.atcon)
	e3:SetCost(c100207025.atcost)
	e3:SetOperation(c100207025.atop)
	c:RegisterEffect(e3)
	--Destroy
	...
	e4:SetCondition(c100207025.descon)
	e4:SetOperation(c100207025.desop)
	c:RegisterEffect(e4)
end
...
function c100207025.atop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToBattle() then
		...
		e1:SetCondition(c100207025.ancon)
