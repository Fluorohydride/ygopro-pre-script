...
function c100207023.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(100207023,0))
	...
	e5:SetCondition(c100207023.damcon)
	e5:SetTarget(c100207023.damtg)
	e5:SetOperation(c100207023.damop)
	c:RegisterEffect(e5)
	--Destroy
	...
	e7:SetCondition(c100207023.descon)
	e7:SetOperation(c100207023.desop)
	c:RegisterEffect(e7)
end
