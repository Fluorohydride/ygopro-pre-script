...
function c100427002.initial_effect(c)
	...
	e2:SetCondition(c100427002.spcon)
	e2:SetOperation(c100427002.spop)
	c:RegisterEffect(e2)
	--search
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(100427002,0))
	e3:SetCategory(CATEGORY_TOHAND+CATEGORY_SEARCH+CATEGORY_TODECK)
	e3:SetType(EFFECT_TYPE_IGNITION)
	e3:SetRange(LOCATION_MZONE)
	e3:SetCountLimit(1)
	e3:SetCondition(c100427002.srcon)
	e3:SetTarget(c100427002.srtg)
	e3:SetOperation(c100427002.srop)
	c:RegisterEffect(e3)
	--recover
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(100427002,1))
	e4:SetCategory(CATEGORY_TOHAND+CATEGORY_TODECK)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_MZONE)
	e4:SetCountLimit(1)
	e4:SetCondition(c100427002.rccon)
	e4:SetTarget(c100427002.rctg)
	e4:SetOperation(c100427002.rcop)
	c:RegisterEffect(e4)
end
