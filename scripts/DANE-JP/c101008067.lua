...
function c101008067.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c101008067.filter2,tp,0,LOCATION_MZONE,1,nil)
		and Duel.IsExistingTarget(c101008067.filter1,tp,LOCATION_MZONE,0,1,nil) end
