...
function c101008035.initial_effect(c)
    c:EnableReviveLimit()
    --synchro summon
    aux.AddSynchroMixProcedure(c,c101008035.matfilter1,nil,nil,aux.NonTuner(Card.IsType,TYPE_MONSTER),1,99)   
    --search
    ...
    e2:SetDescription(aux.Stringid(101008035,2))
    e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
    e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
    e2:SetProperty(EFFECT_FLAG_DELAY+EFFECT_FLAG_DAMAGE_STEP)
    e2:SetCode(EVENT_TO_GRAVE)
    e2:SetCountLimit(1,101008036)
