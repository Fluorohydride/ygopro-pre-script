...
--
--Script by real_scl
--need TIMING_BATTLED to replace TIMING_DAMAGE
function c101008061.initial_effect(c)
	--effect
...
function c101008061.activate(e,tp,eg,ep,ev,re,r,rp)
	if e:GetLabel()==1 then
		local e1=Effect.CreateEffect(e:GetHandler())
		e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		e1:SetCode(EVENT_CHAINING)
		e1:SetOperation(c101008061.actop)
...
function c101008061.actop(e,tp,eg,ep,ev,re,r,rp)
	local rc=re:GetHandler()
	if re:IsActiveType(TYPE_MONSTER) and rc:IsSetCard(0x116) and ep==tp then
		Duel.SetChainLimit(c101008061.chainlm)
	end
end
function c101008061.chainlm(e,rp,tp)
	return tp==rp
end
