...
function c14357527.spcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return (Duel.GetCurrentPhase()==PHASE_MAIN1 or Duel.GetCurrentPhase()==PHASE_MAIN2) and c:IsReason(REASON_EFFECT) and rp==1-tp and c:IsPreviousControler(c:GetOwner()) and c:IsPreviousLocation(LOCATION_ONFIELD)
end
