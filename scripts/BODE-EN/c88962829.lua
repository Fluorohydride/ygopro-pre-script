...
function c88962829.initial_effect(c)
	...
	e3:SetCountLimit(1,88962829+100)
...
function c88962829.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(aux.NecroValleyFilter(c88962829.thfilter),tp,LOCATION_GRAVE+LOCATION_REMOVED,0,nil,e)
...
function c88962829.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if #g>0 and Duel.SendtoHand(g,nil,REASON_EFFECT)>0 then
		...
		for tc in aux.Next(tg) do
			tc:RegisterFlagEffect(88962829,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_IGNORE_IMMUNE+EFFECT_FLAG_SET_AVAILABLE,1)
...
function c88962829.aclimit(e,re,tp)
	return re:GetHandler():IsCode(e:GetLabel()) or re:GetHandler():GetFlagEffect(88962829)>0
end
