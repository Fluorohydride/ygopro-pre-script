...
function c101106000.cfilter(c,tp)
	...
	return c:IsFaceup() and c:IsSummonType(SUMMON_TYPE_RITUAL,SUMMON_TYPE_FUSION,SUMMON_TYPE_SYNCHRO,SUMMON_TYPE_XYZ)
		and Duel.IsExistingMatchingCard(c101106000.typfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,sumtype)
end
