...
--
--script by 原初灵心
function c100239005.initial_effect(c)
	--Activate
...
--	e2:SetDescription(aux.Stringid(100239005,0))
	...
	e2:SetCountLimit(1,100239005)
	e2:SetTarget(c100239005.target)
	e2:SetOperation(c100239005.operation)
	c:RegisterEffect(e2)
end
function c100239005.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
