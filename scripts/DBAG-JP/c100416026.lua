...
function c100416026.efilter(e,te)
	local cid=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return cid==e:GetLabel()
end
function c100416026.rmlimit(e,c,tp,r)
	local cid=Duel.GetChainInfo(0,CHAININFO_CHAIN_ID)
	return c:IsControler(e:GetHandlerPlayer()) and c:IsLocation(LOCATION_PZONE) and r&REASON_EFFECT~=0 and cid==e:GetLabel()
end
