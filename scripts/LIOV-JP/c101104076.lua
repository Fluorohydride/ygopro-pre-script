...
function c101104076.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(101104076,0))
...
function c101104076.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c101104076.spfilter,tp,LOCATION_GRAVE,0,1,eg,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c101104076.spfilter,tp,LOCATION_GRAVE,0,1,1,eg,e,tp)
