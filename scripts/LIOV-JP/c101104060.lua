...
function c101104060.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local rc=Duel.SelectMatchingCard(tp,c101104060.chkfilter,tp,LOCATION_HAND+LOCATION_EXTRA,0,1,1,nil,tp):GetFirst()
	if rc then
		...
		local g=Duel.SelectMatchingCard(tp,c101104060.thfilter,tp,LOCATION_DECK,0,1,1,nil,att)
		if #g>0 then
	...
	e3:SetValue(c101104060.actlimit)
