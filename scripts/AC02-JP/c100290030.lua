...
function c100290030.counter_filter(c)
	return c:IsFaceup() and c:IsCode(100290029)
end
function c100290030.countercond(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c100290030.counter_filter,tp,LOCATION_ONFIELD,0,1,nil)
end
function c100290030.countertg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(1-tp) and chkc:IsFaceup() end
	local ct=Duel.GetMatchingGroupCount(c100290030.counter_filter,tp,LOCATION_MZONE,0,nil)
...
function c100290030.disable_condition(e)
...
function c100290030.counterop(e,tp,eg,ep,ev,re,r,rp)
	...
	for tc in aux.Next(g) do
		if tc:AddCounter(0x1101,1) then
			...
			e1:SetCondition(c100290030.disable_condition)
