...
function c700908005.initial_effect(c)
	--pendulum summon
	...
	e1:SetValue(c700908005.aclimit)
	e1:SetCondition(c700908005.actcon)
	c:RegisterEffect(e1)
	--negate attack
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c700908005.condition)
	e2:SetCost(c700908005.cost)
	e2:SetOperation(c700908005.operation)
	c:RegisterEffect(e2)
end
...
function c700908005.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()~=tp
end
function c700908005.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c700908005.operation(e,tp,eg,ep,ev,re,r,rp)
