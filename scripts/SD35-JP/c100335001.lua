...
--Script by nekrozar
function c100335001.initial_effect(c)
	--recover
	...
	e1:SetTarget(c100335001.rectg)
	e1:SetOperation(c100335001.recop)
	c:RegisterEffect(e1)
	--tohand
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(100335001,1))
	e2:SetCategory(CATEGORY_TOHAND)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_BATTLE_DESTROYED)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,100335001)
	e2:SetCondition(c100335001.thcon)
	e2:SetTarget(c100335001.thtg)
	e2:SetOperation(c100335001.thop)
	c:RegisterEffect(e2)
end
function c100335001.reccon(e,tp,eg,ep,ev,re,r,rp)
	local at=Duel.GetAttackTarget()
	return at:IsControler(tp) and at:IsFaceup() and at:IsSetCard(0x119)
end
function c100335001.reccost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100335001.recop(e,tp,eg,ep,ev,re,r,rp)
...
function c100335001.thcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100335001.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsAbleToHand() end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,e:GetHandler(),1,0,0)
end
function c100335001.thop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
