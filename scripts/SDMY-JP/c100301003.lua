...
function c100301003.initial_effect(c)
	...
	e1:SetTarget(c100301003.thtg)
	e1:SetOperation(c100301003.thop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c100301003.thfilter(c)
	return (c:IsSetCard(0x2066) or c:IsCode(99785935,39256679,11549357)) and not c:IsCode(100301003) and c:IsLevelBelow(4) and c:IsAbleToHand()
end
function c100301003.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c100301003.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c100301003.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c100301003.thfilter,tp,LOCATION_DECK,0,1,1,nil)
