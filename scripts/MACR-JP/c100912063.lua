...
function c100912063.filter(c)
	...
	if c:IsType(TYPE_MONSTER) then
		return c:IsType(TYPE_PENDULUM) and (c:IsSetCard(0xf0) or c:IsCode(100331003,92746535,75195825,69512157,7127502,16178681,47075569))
	else
		return c:IsSetCard(0xf0) or c:IsCode(37803970,2359348,76660409,53208660,100214004,68477598,60434189,77826734,74926274,69982329,83461421)
	end
end
