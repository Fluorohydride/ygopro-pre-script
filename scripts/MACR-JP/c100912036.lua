...
function c100912036.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	local ex4,g4,gc4,dp4,dv4=Duel.GetOperationInfo(ev,CATEGORY_DRAW)
	return ep~=tp and ((ex1 and bit.band(dv1,LOCATION_DECK)==LOCATION_DECK)
		...
		or (ex4 and bit.band(dv4,LOCATION_DECK)==LOCATION_DECK)
		or eg:IsExists(Card.IsCode,1,nil,23434538,44394295,58577036,47222536)) and Duel.IsChainDisablable(ev)
end
