...
function c100912014.spfilter(c,e,tp)
	return c:IsSetCard(0xf8) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c100912014.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c100912014.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,nil,e,tp) end
