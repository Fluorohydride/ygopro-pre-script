...
function c100912044.spfilter(c,e,tp)
	return c:IsType(TYPE_XYZ) and c:IsSetCard(0xba) and not c:IsCode(100912044) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
function c100912044.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c100912044.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
