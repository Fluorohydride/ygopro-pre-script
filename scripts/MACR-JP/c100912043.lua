...
function c100912043.initial_effect(c)
	...
	e4:SetCountLimit(1)
	e4:SetCost(c100912043.indcost)
	e4:SetOperation(c100912043.indop)
	c:RegisterEffect(e4)
end
...
function c100912043.indcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():CheckRemoveOverlayCard(tp,1,REASON_COST) end
	e:GetHandler():RemoveOverlayCard(tp,1,1,REASON_COST)
end
function c100912043.indop(e,tp,eg,ep,ev,re,r,rp)
