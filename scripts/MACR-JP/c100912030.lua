...
function c100912030.initial_effect(c)
	...
	e4:SetOperation(c100912030.penop)
	c:RegisterEffect(e4)
	--special summon
	local e5=Effect.CreateEffect(c)
	e5:SetDescription(aux.Stringid(100912030,3))
	e5:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetRange(LOCATION_MZONE)
	e5:SetCountLimit(1)
	e5:SetCost(c100912030.spcost)
	e5:SetTarget(c100912030.sptg)
	e5:SetOperation(c100912030.spop)
	c:RegisterEffect(e5)
end
...
function c100912030.penop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	local e1=Effect.CreateEffect(c)
...
function c100912030.checkop(e,tp)
	...
	e1:SetCondition(c100912030.pencon1)
	e1:SetOperation(c100912030.penop1)
...
function c100912030.pencon1(e,c,og)
	if c==nil then return true end
	local tp=c:GetControler()
...
function c100912030.penop1(e,tp,eg,ep,ev,re,r,rp,c,sg,og)
