...
function c100912101.thfilter(c,tp)
	return (c:IsSetCard(0x1f8) or c:IsCode(30539496,34079868,82321037,87765315,96746083)) and c:GetType()==0x20002 and (c:IsAbleToHand() or c:GetActivateEffect():IsActivatable(tp))
end
