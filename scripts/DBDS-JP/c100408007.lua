...
function c100408007.initial_effect(c)
	...
	e2:SetTarget(c100408007.gytg)
	e2:SetOperation(c100408007.gyop)
	c:RegisterEffect(e2)
	--spsummon
...
function c100408007.gytg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100408007.gyop(e,tp,eg,ep,ev,re,r,rp)
...
function c100408007.spfilter(c,e,tp)
	return c:IsControler(1-tp) and c:IsReason(REASON_BATTLE+REASON_EFFECT)
