...
function c100421022.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100421022,1))
	...
	e2:SetCondition(c100421022.negcon)
	e2:SetCost(c100421022.negcost)
	e2:SetTarget(c100421022.negtg)
	e2:SetOperation(c100421022.negop)
	c:RegisterEffect(e2)
end
...
function c100421022.rectg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.GetMatchingGroup(c100421022.recfilter,tp,LOCATION_MZONE,0,nil)
...
function c100421022.negcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100421022.negcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c100421022.cfilter,tp,LOCATION_HAND,0,1,nil) end
	Duel.DiscardHand(tp,c100421022.cfilter,1,1,REASON_COST+REASON_DISCARD,nil)
end
function c100421022.negtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return true end
	Duel.SetOperationInfo(0,CATEGORY_NEGATE,eg,1,0,0)
end
function c100421022.negop(e,tp,eg,ep,ev,re,r,rp)
