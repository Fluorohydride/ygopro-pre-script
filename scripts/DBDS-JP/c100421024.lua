...
function c100421024.initial_effect(c)
	...
	e2:SetCondition(c100421024.condition)
	...
	e3:SetCondition(c100421024.descon)
	e3:SetCost(c100421024.descost)
	e3:SetTarget(c100421024.destg)
...
function c100421024.destg(e,tp,eg,ep,ev,re,r,rp,chk)
