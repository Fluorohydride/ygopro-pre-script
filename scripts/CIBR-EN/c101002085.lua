...
function c101002085.spfilter(c,lv,ft,g,sg,bs)
	...
	return nlv>0 and (nlv==0 or (not bs and g2:IsExists(c101002085.spfilter,1,sg2,nlv,ft-1,g2,sg2,bs)))
end
...
function c101002085.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	while g:GetCount()>0 and ft>0 and lv>0 then
		...
		local sc=g:FilterSelect(tp,c101002085.spfilter,1,1,sg,lv,ft,g,sg,bs):GetFirst()
		sg:AddCard(sc)
