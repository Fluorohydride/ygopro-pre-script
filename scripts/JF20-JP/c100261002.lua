...
function c100261002.initial_effect(c)
	--special summon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(100261002,0))
	e1:SetCategory(CATEGORY_POSITION+CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetRange(LOCATION_HAND+LOCATION_GRAVE)
	e1:SetCountLimit(1,100261002)
	e1:SetTarget(c100261002.sptg)
	e1:SetOperation(c100261002.spop)
	c:RegisterEffect(e1)
end
function c100261002.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100261002.spop(e,tp,eg,ep,ev,re,r,rp)
