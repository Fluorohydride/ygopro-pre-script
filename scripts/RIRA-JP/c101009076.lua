...
--Script by nekrozar
function c101009076.initial_effect(c)
	--Activate
	...
	e1:SetCountLimit(1,101009076+EFFECT_COUNT_CODE_OATH)
	e1:SetHintTiming(0,TIMINGS_CHECK_MONSTER+TIMING_END_PHASE)
	e1:SetTarget(c101009076.target)
	e1:SetOperation(c101009076.activate)
	c:RegisterEffect(e1)
end
function c101009076.filter(c)
...
function c101009076.activate(e,tp,eg,ep,ev,re,r,rp)
