...
--Script by nekrozar
function c101009065.initial_effect(c)
	--Activate
	...
	e2:SetTarget(c101009065.reptg1)
	e2:SetValue(c101009065.repval)
	e2:SetOperation(c101009065.repop1)
	c:RegisterEffect(e2)
	--destroy replace
	...
	e3:SetTarget(c101009065.reptg2)
	e3:SetValue(c101009065.repval)
	e3:SetOperation(c101009065.repop2)
	c:RegisterEffect(e3)
end
function c101009065.repfilter1(c,tp)
...
function c101009065.reptg1(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101009065.repval(e,c)
...
function c101009065.reptg2(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
