...
function c56773577.initial_effect(c)
	...
	e3:SetDescription(aux.Stringid(56773577,0))
	e3:SetType(EFFECT_TYPE_QUICK_O)
	e3:SetRange(LOCATION_SZONE)
	e3:SetCode(EVENT_FREE_CHAIN)
	e3:SetCountLimit(1)
	e3:SetCondition(c56773577.accon)
	e3:SetTarget(c56773577.actg)
	e3:SetOperation(c56773577.acop)
	c:RegisterEffect(e3)
	--set
	local e4=Effect.CreateEffect(c)
	e4:SetDescription(aux.Stringid(56773577,1))
	e4:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e4:SetCode(EVENT_TO_GRAVE)
	e4:SetProperty(EFFECT_FLAG_DELAY)
	e4:SetCondition(c56773577.setcon)
	e4:SetTarget(c56773577.settg)
	e4:SetOperation(c56773577.setop)
	c:RegisterEffect(e4)
end
