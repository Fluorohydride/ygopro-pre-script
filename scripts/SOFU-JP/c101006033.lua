...
function c101006033.initial_effect(c)
	...
	e2:SetValue(c101006033.valcheck)
...
function c101006033.effcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectReleaseGroup(tp,c101006033.cfilter,1,1,nil)
	Duel.Release(g,REASON_COST)
end
function c101006033.effop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if c:IsFaceup() and c:IsRelateToEffect(e) then
		local e1=Effect.CreateEffect(c)
		e1:SetDescription(aux.Stringid(101006033,2))
...
function c101006033.destg2(e,tp,eg,ep,ev,re,r,rp,chk)
