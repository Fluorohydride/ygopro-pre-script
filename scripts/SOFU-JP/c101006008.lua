...
function c101006008.thfilter(c)
	return ((c:IsSetCard(0x11a) and c:IsType(TYPE_MONSTER)) or c:IsCode(101006054)) and c:IsAbleToHand()
end
...
function c101006008.spfilter(c,e,tp)
	return c:IsSetCard(0x11a) and not c:IsCode(101006008) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
