--犀子国王
--Lua by Gim J.Blocks
function c101203036.initial_effect(c)
	--dice
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c101203036.target)
	e1:SetOperation(c101203036.operation)
	c:RegisterEffect(e1)
end
function c101203036.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101203036.operation(e,tp,eg,ep,ev,re,r,rp)
