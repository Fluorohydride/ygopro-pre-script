...
function c100260017.initial_effect(c)
	...
	e1:SetTarget(c100260017.target)
	e1:SetOperation(c100260017.activate)
	c:RegisterEffect(e1)
end
function c100260017.filter1(c,e)
	return c:IsCanBeFusionMaterial() and c:IsType(TYPE_PENDULUM) and c:IsAbleToRemove() and (not e or not c:IsImmuneToEffect(e))
end
function c100260017.filter2(c,e,tp,m,f,chkf)
	return c:IsType(TYPE_FUSION) and (not f or f(c))
		and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_FUSION,tp,false,false) and c:CheckFusionMaterial(m,nil,chkf)
end
function c100260017.filter3(c)
	...
	if chk==0 then
		...
		if not res then
			...
			if ce~=nil then
				...
				local mg2=fgroup(ce,e,tp):Filter(c100260017.filter3,nil)
				local mf=ce:GetValue()
				res=Duel.IsExistingMatchingCard(c100260017.filter2,tp,LOCATION_EXTRA,0,1,nil,e,tp,mg2,mf,chkf)
			end
		end
		return res
	end
...
function c100260017.activate(e,tp,eg,ep,ev,re,r,rp)
	local chkf=tp
	local mg1=Duel.GetMatchingGroup(c100260017.filter1,tp,LOCATION_GRAVE,0,nil,e)
	...
	if ce~=nil then
		local fgroup=ce:GetTarget()
		mg2=fgroup(ce,e,tp):Filter(c100260017.filter3,nil)
		local mf=ce:GetValue()
		sg2=Duel.GetMatchingGroup(c100260017.filter2,tp,LOCATION_EXTRA,0,nil,e,tp,mg2,mf,chkf)
	end
