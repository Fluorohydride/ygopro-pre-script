...
function c100260006.initial_effect(c)
	...
	e2:SetTarget(c100260006.target)
	e2:SetOperation(c100260006.operation)
	c:RegisterEffect(e2)
	--extra attack
	local e3=Effect.CreateEffect(c)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e3:SetCode(EVENT_BE_MATERIAL)
	e3:SetCondition(c100260006.atkcon)
	e3:SetOperation(c100260006.atkop)
	c:RegisterEffect(e3)
end
...
function c100260006.atkcon(e,tp,eg,ep,ev,re,r,rp)
	local rc=e:GetHandler():GetReasonCard()
	return r==REASON_LINK and rc:IsType(TYPE_LINK) and rc:IsSetCard(0x10b)
end
function c100260006.atkop(e,tp,eg,ep,ev,re,r,rp)
