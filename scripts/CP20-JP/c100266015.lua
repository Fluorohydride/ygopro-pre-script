...
function c100266015.initial_effect(c)
	...
	e2:SetCondition(c100266015.thcon)
...
function c100266015.thcon(e,tp,eg,ep,ev,re,r,rp)
...
function c100266015.thop(e,tp,eg,ep,ev,re,r,rp)
	...
	if g and Duel.SendtoGrave(g,REASON_EFFECT) and tc:IsRelateToEffect(e) then
