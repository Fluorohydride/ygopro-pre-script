--ZS-双頭龍賢者
--Script by XyLeN
function c100278026.initial_effect(c)
	--spsummon
	...
	e2:SetDescription(aux.Stringid(100278026,1))
	e2:SetCategory(CATEGORY_ATKCHANGE)
	e2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_O)
	e2:SetCode(EVENT_ATTACK_ANNOUNCE)
	e2:SetRange(LOCATION_SZONE)
	e2:SetCondition(c100278026.atkcon)
	e2:SetOperation(c100278026.atkop)
	c:RegisterEffect(e2)
end
...
function c100278026.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetCondition(c100278026.atklimitcon)
	e3:SetTarget(c100278026.atklimittg)
	...
	e4:SetOperation(c100278026.checkop)
...
function c100278026.atklimitcon(e)
	return e:GetLabel()~=0
end
function c100278026.atklimittg(e,c)
	return c:GetFieldID()~=e:GetLabel()
end
function c100278026.checkop(e,tp,eg,ep,ev,re,r,rp)
...
function c100278026.atkop(e,tp,eg,ep,ev,re,r,rp)
	...
	tc:RegisterFlagEffect(100278026,RESET_EVENT+RESETS_STANDARD,0,1,fid)
	...
	e2:SetCondition(c100278026.descon)
	e2:SetOperation(c100278026.desop)
	Duel.RegisterEffect(e2,tp)
end
function c100278026.descon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
	if tc:GetFlagEffectLabel(100278026)==e:GetLabel() then
		return true
	else
		e:Reset()
		return false
...
function c100278026.desop(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetLabelObject()
