...
function c100278034.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(100278034,1))
	e5:SetCategory(CATEGORY_ATKCHANGE+CATEGORY_DEFCHANGE+CATEGORY_DAMAGE)
	e5:SetType(EFFECT_TYPE_IGNITION)
	e5:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e5:SetRange(LOCATION_MZONE)
	e5:SetCountLimit(1,100278034)
	e5:SetCost(c100278034.copycost)
	e5:SetTarget(c100278034.copytg)
	e5:SetOperation(c100278034.copyop)
	c:RegisterEffect(e5)
	--to pzone
	local e6=Effect.CreateEffect(c)
	e6:SetDescription(aux.Stringid(100278034,2))
	e6:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e6:SetCode(EVENT_DESTROYED)
	e6:SetProperty(EFFECT_FLAG_DELAY)
	e6:SetCondition(c100278034.pencon)
	e6:SetTarget(c100278034.pentg)
	e6:SetOperation(c100278034.penop)
	c:RegisterEffect(e6)
end
