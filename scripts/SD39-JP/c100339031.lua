...
function c100339031.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100339031,1))
...
function c100339031.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if mg:GetClassCount(Card.GetAttribute)>=2 and g:GetCount()>0 and Duel.SelectYesNo(tp,aux.Stringid(100339031,0)) then
...
function c100339031.tftg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingTarget(c100339031.tffilter,tp,LOCATION_GRAVE,0,1,nil) end
