...
function c100287022.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c100287022.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
...
function c100287022.spcheck(c,tp,rc,mg,opchk)
...
function c100287022.scfilter(c,e,tp,rc,chkrel,chknotrel,tgchk,opchk)
	...
	mg:AddCard(c)
	if tgchk then
		return c100287022.spcheck(c,tp,nil,mg,opchk)
	else
		return (chkrel and c100287022.spcheck(c,tp,rc,mg-rc)) or (chknotrel and c100287022.spcheck(c,tp,nil,mg))
	end
end
function c100287022.sccost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local b1=chkrel and Duel.IsExistingMatchingCard(c100287022.scfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,chkrel,nil)
	local b2=chknotrel and Duel.IsExistingMatchingCard(c100287022.scfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp,c,nil,chknotrel)
