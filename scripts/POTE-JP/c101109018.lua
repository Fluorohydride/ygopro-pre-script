...
function c101109018.thcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return e:GetHandler():IsDiscardable()
		and (fe or Duel.IsExistingMatchingCard(c101109018.costfilter,tp,LOCATION_HAND,0,1,e:GetHandler())) end
	if fe and Duel.SelectYesNo(tp,aux.Stringid(101109061,0)) then
		...
		local g=Duel.SelectMatchingCard(tp,c101109018.costfilter,tp,LOCATION_HAND,0,1,1,e:GetHandler())
