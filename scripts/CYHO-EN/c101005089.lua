...
function c101005089.initial_effect(c)
	--xyz summon
	aux.AddXyzProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x107a),3,2,nil,nil,99)
	c:EnableReviveLimit()
	--to hand
...
function c101005089.thop(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c101005089.spfilter(c,e,tp)
	return c:IsSetCard(0x107a) and not c:IsCode(101005089) and c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_XYZ,tp,false,false)
end
