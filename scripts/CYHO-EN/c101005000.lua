...
function c101005000.cfilter2(c,e,tp,tc)
	...
	local g=Duel.GetMatchingGroup(c101005000.spfilter,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE,0,sg,e,tp)
...
function c101005000.target(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(c101005000.spfilter,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE,0,nil,e,tp)
...
function c101005000.confilter(c,tp)
	return aux.IsMaterialListCode(c,89943723) and c:IsPreviousLocation(LOCATION_ONFIELD)
