...
function c101010002.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(101010002,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetRange(LOCATION_HAND+LOCATION_GRAVE)
	e1:SetCountLimit(1,101010002)
	e1:SetCondition(c101010002.spcon)
	e1:SetTarget(c101010002.sptg)
	e1:SetOperation(c101010002.spop)
	c:RegisterEffect(e1)
end
function c101010002.cfilter(c)
