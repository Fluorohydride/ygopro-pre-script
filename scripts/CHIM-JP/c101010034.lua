...
function c101010034.initial_effect(c)
	...
	e1:SetCondition(c101010034.thcon)
	e1:SetTarget(c101010034.thtg)
	e1:SetOperation(c101010034.thop)
	c:RegisterEffect(e1)
	--cannot be target
	...
	e2:SetCondition(c101010034.tgcon)
...
function c101010034.thcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsSummonType(SUMMON_TYPE_SYNCHRO)
end
function c101010034.thfilter(c)
	return c:IsCode(92266279,28265983,101010074) and c:IsAbleToHand()
end
function c101010034.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c101010034.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c101010034.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c101010034.thfilter,tp,LOCATION_DECK,0,1,1,nil)
	if g:GetCount()>0 then
		Duel.SendtoHand(g,nil,REASON_EFFECT)
		Duel.ConfirmCards(1-tp,g)
	end
end
function c101010034.tgcon(e)
