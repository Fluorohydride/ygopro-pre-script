...
function c101010058.initial_effect(c)
	...
	e2:SetCondition(c101010058.tgcon)
	e2:SetTarget(c101010058.tglimit)
	...
	e3:SetCountLimit(1,101010058)
	e3:SetCondition(c101010058.spcon)
	e3:SetTarget(c101010058.sptg)
	e3:SetOperation(c101010058.spop)
	c:RegisterEffect(e3)
end
function c101010058.tgcon(e)
...
function c101010058.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c101010058.filter,tp,LOCATION_DECK,0,1,nil,e,tp) end
