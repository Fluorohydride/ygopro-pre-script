...
function c100909005.initial_effect(c)
	...
	e1:SetOperation(c100909005.op1)
	c:RegisterEffect(e1)
	--M.Zone
	local e2=e1:Clone()
	e2:SetRange(LOCATION_MZONE)
	e2:SetOperation(c100909005.op2)
	c:RegisterEffect(e2)
end
...
function c100909005.op1(e,tp,eg,ep,ev,re,r,rp)
...
function c100909005.op2(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.GetFirstTarget()
	if tc:IsRelateToEffect(e) then
		local e1=Effect.CreateEffect(e:GetHandler())
		e1:SetType(EFFECT_TYPE_SINGLE)
