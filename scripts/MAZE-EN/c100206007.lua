...
function c100206007.initial_effect(c)
	...
	e1:SetTarget(c100206007.target)
	c:RegisterEffect(e1)
	--to field
	...
	e2:SetTarget(c100206007.tftg)
	e2:SetOperation(c100206007.tfop)
	c:RegisterEffect(e2)
	--destroy
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(100206007,2))
	...
	e3:SetCondition(c100206007.descon)
	e3:SetTarget(c100206007.destg)
	e3:SetOperation(c100206007.desop)
	c:RegisterEffect(e3)
end
