...
function c100206003.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(100206003,0))
	...
	e3:SetDescription(aux.Stringid(100206003,1))
...
function c100206003.discfilter(c,tp)
...
function c100206003.discon(e,tp,eg,ep,ev,re,r,rp)
	...
	return tg and tg:IsExists(c100206003.discfilter,1,nil,tp) and Duel.IsChainDisablable(ev)
end
